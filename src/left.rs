...
pub struct CorneLeft;

// Basic keyboard configuration
use rumcake::keyboard::Keyboard;
impl Keyboard for CorneLeft {
...
impl KeyboardLayout for CorneLeft {
    build_layout! {
        {
...
impl KeyboardMatrix for CorneLeft {
...
impl USBKeyboard for CorneLeft {
